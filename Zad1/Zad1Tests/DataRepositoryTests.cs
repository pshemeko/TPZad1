    ...
    */
    [TestMethod()]
        ...
        public void DeleteZdarzenieTest()
        {
            ...
            Assert.AreEqual(0, repozytorium.SizeOfZdarzenia());
            repozytorium.AddZdarzenie(zd);
            repozytorium.AddZdarzenie(zd2);
            Assert.AreEqual(2, repozytorium.SizeOfZdarzenia());

            //bool wynik = repozytorium.DeleteZdarzenie(zd); //////TODO tu blad
            //Assert.AreEqual(1, repozytorium.SizeOfZdarzenia());
        }
        ...
        public void DeleteOpisStanuEgzemplarzaTest()
        {
            ...
            Assert.AreEqual(0, repozytorium.SizeOfOpisStanow());
            repozytorium.AddOpisStanuEgzemplarza(op1);
            repozytorium.AddOpisStanuEgzemplarza(op2);
            Assert.AreEqual(2, repozytorium.SizeOfOpisStanow());

            //repozytorium.DeleteOpisStanuEgzemplarza(op1);
            //Assert.AreEqual(1, repozytorium.SizeOfOpisStanow());
        }
    }
}